import require$$0, { createContext, useContext, useMemo, useCallback } from 'react';
...
var context$2 = /*#__PURE__*/createContext(_objectSpread$2(_objectSpread$2({}, DEFAULT_MARKDOWN_OPTIONS), {}, {
...
function CodeBlockRenderer(_ref3) {
  ...
  return /*#__PURE__*/jsxRuntime.exports.jsx("pre", {
    ...
    children: /*#__PURE__*/jsxRuntime.exports.jsx("code", {
      ref: useCallback(function (instance) {
...
var context$1 = /*#__PURE__*/createContext(new marked.Slugger());
...
var context = /*#__PURE__*/createContext(DEFAULT_MARKDOWN_RENDERERS);
...
export { BlockquoteRenderer, BrRenderer, CODE_RENDERERS, CodeBlockRenderer, CodeSpanRenderer, DEFAULT_GET_LANGUAGE, DEFAULT_MARKDOWN_OPTIONS, DEFAULT_MARKDOWN_RENDERERS, DelRenderer, EmRenderer, EscapeRenderer, HTML_RENDERERS, HeadingRenderer, HrRenderer, HtmlRenderer, ImageRenderer, LIST_RENDERERS, LinkRenderer, ListItemRenderer, ListRenderer, MEDIA_RENDERERS, Markdown, MarkdownCodeProvider, MarkdownRenderersProvider, MarkdownSluggerProvider, PRESENTATIONAL_RENDERERS, ParagraphRenderer, SpaceRenderer, StrongRenderer, TABLE_RENDERERS, TEXT_RENDERERS, TableRenderer, TagRenderer, TaskRenderer, TbodyRenderer, TdRenderer, TextRenderer, ThRenderer, TheadRenderer, TokenRenderer, TokensRenderer, TrRenderer, getTokensText, marked, useMarkdownConfig, useMarkdownRenderers, useMarkdownSlugger, useSluggedId };
