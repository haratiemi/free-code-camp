...
import { HighlightCodeOptions, MarkdownRenderers, MarkdownOptions, ValidHighlightCodeOptions } from "./renderers";
 ...
 */
export declare type MarkdownProps = BaseMarkdownProps & ValidHighlightCodeOptions;
/**
 ...
 * ```
 */
export declare function Markdown({ options, slugger, markdown, renderers, getLanguage, highlightCode, highlightElement, }: MarkdownProps): ReactElement;
